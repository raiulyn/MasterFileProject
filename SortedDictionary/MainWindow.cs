...
namespace GeneralDictionary
{
    public partial class MainWindow : Form
    {
        ...
        // 6.10 Add suitable error trapping and user feedback via a status strip or similar to ensure a fully functional User Experience. Make all methods private and ensure the Dictionary is static and public.
